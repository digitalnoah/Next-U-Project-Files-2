...
Inside that folder, create one build file, one QA file, and one human validation file for each phase.

Use this naming pattern:

- `phase-01-build.md`
- `phase-01-qa.md`
- `phase-01-human-validation.md`

Repeat for each phase.

Create the following phases unless my answers suggest a better structure:

## Phase 1: Content Strategy and Page Architecture

Define the page sections, message hierarchy, CTA strategy, and rough page flow.
...
## Phase 2: Visual System and Layout

Apply the brand guide, logo assets, palette, typography direction, spacing, grid, and visual hierarchy.

Files:

- `phase-02-build.md`
- `phase-02-qa.md`
- `phase-02-human-validation.md`

## Phase 3: Landing Page Build

Plan the `prototype.html` page structure, content, styling, and responsive layout.

Files:

- `phase-03-build.md`
- `phase-03-qa.md`
- `phase-03-human-validation.md`

## Phase 4: Signup Form and Interaction

Plan the email signup form, validation, simulated success state, and clear explanation of what is functional versus simulated.

Files:

- `phase-04-build.md`
- `phase-04-qa.md`
- `phase-04-human-validation.md`

## Phase 5: Final Review and Refinement

Plan a full review against the brief, persona, value prop, brand guide, and conversion goal. Include clarity, polish, accessibility, and mobile responsiveness checks.

Files:

- `phase-05-build.md`
- `phase-05-qa.md`
- `phase-05-human-validation.md`
